...
const Content = () => {
  ...
  return (
    <>
    {
      ...
      <div className='flex w-[100vw] h-[50vh] justify-center gap-3 mt-3 items-center'>
      {images.map((item)=>( <img src={item} alt="testing"  className='w-[20%] h-[80%] text-white hover:h-[100%]' onClick={()=>{
setImg(item)
      }}/>)
